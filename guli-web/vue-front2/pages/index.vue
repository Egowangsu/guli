        ...
        <section class="container">
          ...
          <div>
            <article class="comm-course-list">
              <ul id="bna" class="of">
                <li v-for="(edu,index) in eduList" :key="index">
                  <div class="cc-l-wrap">
                    ...
                    <h3 class="hLh30 txtOf mt10">
                      <a href="#" title="听力口语" class="course-title fsize18 c-333">{{ edu.title }}</a>
                    </h3>
                    <section class="mt10 hLh20 of">
                      <span v-if="Number(edu.price)===0" class="fr jgTag bg-green">
