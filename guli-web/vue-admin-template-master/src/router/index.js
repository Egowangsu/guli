...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '添加讲师', icon: 'tree' } // 前端显示的数据
      },
      {
        path: 'edit/:id',
        name: '修改讲师',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '添加课程分类', icon: 'tree' } // 前端显示的数据
      }
    ]
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '添加课程', icon: 'tree' } // 前端显示的数据
      },
      {
        path: 'info/:id', // 这个路由是实现上一页的跳转信息回显，需要id
        name: '添加课程',
        component: () => import('@/views/edu/course/info'),
        meta: { title: '添加课程', icon: 'tree' }, // 前端显示的数据
        hidden: true
